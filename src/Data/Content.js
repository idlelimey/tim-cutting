export const tools = [
    ...
    },
    {
        ...
        description:
            'Build a multi-layer CSS gradient easily with this generator. Modify the layers gradient angle and set colour stops, you can set the visibility of each layer to make it easier to see what is going on with individual layers.',
        size: 2,
    },
    {
    ...
    },
    {
        ...
        icon: 'password',
        to: 'password-entropy',
        description: "Don't use bad passwords, use this tester and generator and use better passwords.", // eslint-disable-line
    },
    {
...
export const infoCards = [
    {
        ...
        list: ['JavaScript, React', 'Responsive', 'WordPress'],
    },
    {
        icon: 'paint',
        heading: 'Design',
        ...
        content:
            'Attractive and usable design combining the best UX/UI and design practices with browser compatibility.',
        list: ['User Experience', 'Web & Packaging Design', 'Branding'],
    },
    {
        icon: 'seo',
        ...
        list: ['AMP Development', 'Page Optimisation', 'JSON-LD Schema'],
    },
    {
        icon: 'no-bug',
        ...
        content:
            'Browser & device tested for compatibility.  Strict accessibility testing ensures  content is rendered the way you intended.',
        list: ['Device testing', 'Full Browser Compatibility', 'WCAG Compliancy'],
    },
];
